...
class ContributorProposalHistoryListPage extends StatefulWidget {
  const ContributorProposalHistoryListPage({Key? key}) : super(key: key);

  @override
  ContributorProposalHistoryListPageState createState() =>
      ContributorProposalHistoryListPageState();
}
...
class ContributorProposalHistoryListPageState
  ...
  void loadProposals() async {
    try {
      ...
      final proposals = await getHistoryProposalsByFollower(getCID!);
